...
def run_triage_assessment(user_text: str, patient_context_dict: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    """
    patient_context_dict = patient_context_dict or {}
    ...
    return {
        ...
        "recommendation": f"Recommended clinical routing to {best_dept} specialist for formal evaluation.",
        "can_auto_book": True,
        "extracted_context": extracted
    }

def run_triage_agent(patient_input: str, context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    """Compatibility interface for CarePulse AI agent workflows."""
    return run_triage_assessment(patient_input, context)
