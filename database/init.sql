...
ALTER TABLE doctors ADD COLUMN IF NOT EXISTS hospital_name VARCHAR(255) DEFAULT 'CarePulse Central Hospital';
...
-- Note: Initial mock data has been moved to database/seed_data.sql.
-- init.sql is reserved strictly for schema migrations and table definitions.
