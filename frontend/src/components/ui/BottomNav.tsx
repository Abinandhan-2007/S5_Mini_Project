...
export const BottomNav: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-4 sm:bottom-6 left-0 right-0 z-40 flex flex-col items-center pointer-events-none px-3">
      <div className="relative w-full max-w-[340px] sm:max-w-[380px] md:max-w-[420px] pointer-events-auto">
          ...
          <div className="absolute -top-[88px] sm:-top-[96px] right-2 sm:right-3 z-50 pointer-events-auto">
            <button
              ...
              className={clsx(
                ...
                isTransitioning
                  ? 'scale-115 -translate-y-2 brightness-110'
        ...
        <nav
          className={clsx(
            'w-full rounded-full px-2 py-1.5 backdrop-blur-2xl transition-all duration-300 select-none cursor-pointer',
            isDarkMode
            ...
            {navItems.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Theme-Aware Neutral Text Label */}
                  <span
                    className={clsx(
