            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
              <div>
                <label className="block text-[11px] font-bold text-slate-700 mb-1">
                  {t('auth.fullName', 'Full Legal Name')} <span className="text-rose-500">*</span>
                </label>
                <input
                  type="text"
                  value={fullName}
                  onChange={(e) => setFullName(e.target.value)}
                  placeholder={t('auth.fullNamePlaceholder', 'e.g. Sarah Jenkins')}
                  required
              ...
              <div>
                <label className="block text-[11px] font-bold text-slate-700 mb-1">
                  {t('auth.phone', 'Primary Contact Phone')} <span className="text-rose-500">*</span>
                </label>
