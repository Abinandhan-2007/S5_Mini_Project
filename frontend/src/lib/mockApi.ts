...
export const MOCK_DOCTORS: Doctor[] = [
  {
    ...
    reviewsCount: 85,
    experienceYears: 8,
    about: 'Specialist in metabolic health, diabetes management, and endocrine disorders.',
  },
  {
    id: 'doc-marilyn',
    ...
    reviewsCount: 85,
    experienceYears: 10,
    about: 'Primary care physician focused on preventive health & comprehensive checkups.',
  },
  {
    id: 'doc-marvin',
    ...
    reviewsCount: 85,
    experienceYears: 14,
    about: 'Senior Cardiologist specializing in preventive heart health and electrophysiology.',
  },
  {
    id: 'doc-arlene',
    ...
    reviewsCount: 85,
    experienceYears: 11,
    about: 'Internal medicine specialist dedicated to holistic patient care.',
  },
  {
    id: 'doc-eleanor',
    ...
    reviewsCount: 85,
    experienceYears: 9,
    about: 'Specialist in joint health, rheumatoid care, and orthopedic therapy.',
  },
  {
    id: 'doc-kaiya',
    name: 'Dr. Kaiya Donin',
    ...
    reviewsCount: 85,
    experienceYears: 12,
    about: 'Endocrine care expert specializing in thyroid & metabolic health.',
  },
];
