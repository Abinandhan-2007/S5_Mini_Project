              ...
              {doctors.map((doctor) => (
                ...
                >
                  ...
                  <button
                    ...
                    className={`px-3.5 py-1.5 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer hover:scale-[1.02] active:scale-95 ${doctor.isAvailable
