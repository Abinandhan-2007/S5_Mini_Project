            ...
            {navItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`transition-all duration-200 text-sm whitespace-nowrap ${isActive
          ...
          {navItems.map((item) => {
            ...
            return (
              <button
                key={item.id}
                onClick={() => setActiveTab(item.id)}
                className={`px-4 py-2 rounded-full font-bold text-xs whitespace-nowrap transition-all ${isActive ? 'bg-[#0B5A54] text-white shadow-xs' : 'text-slate-600'
                  }`}
              >
                {item.label}
              </button>
