...
const INITIAL_NOTIFICATIONS: ReceptionistNotificationItem[] = [
  {
    id: 'notif-1',
    title: 'Emergency Walk-In Check-In',
    message: 'High priority walk-in patient checked in at Desk 01 requiring urgent Cardiology triage.',
    category: 'urgent',
    priority: 'high',
    timestamp: '10:18 AM',
    timeAgo: '2 mins ago',
    isRead: false,
    actionTab: 'checkin',
    actionLabel: 'View Vitals & Triage',
    sender: 'Triage Desk',
  },
  {
    id: 'notif-2',
    title: 'Token Assigned to Cabin',
    message: 'Token #TOK-002 (Robert Chen) was assigned to Dr. Olivia Wilson (Cabin 102 - 1st Floor).',
    category: 'queue',
    priority: 'medium',
    timestamp: '10:12 AM',
    timeAgo: '8 mins ago',
  ...
  {
    id: 'notif-3',
    title: 'Doctor Cabin Availability Update',
    message: 'Dr. Marcus Vance has checked into Cabin 204 and is now Available for dermatology consultations.',
    category: 'doctor',
    priority: 'medium',
    timestamp: '09:55 AM',
    timeAgo: '25 mins ago',
    isRead: false,
    actionTab: 'doctors',
    actionLabel: 'View Doctor Roster',
    sender: 'Cabin Operations',
  },
  {
    id: 'notif-4',
    title: 'Express Vitals Logged',
    message: 'Elena Rostova (BP: 120/80, SpO2: 99%, Pulse: 72 bpm) check-in completed successfully.',
    category: 'queue',
    priority: 'low',
    timestamp: '09:30 AM',
    timeAgo: '50 mins ago',
    isRead: true,
    actionTab: 'bookings',
    actionLabel: 'View Booking Roster',
    sender: 'Vitals Intake Station',
  },
  {
    id: 'notif-5',
    title: 'Hospital-Wide Maintenance Notice',
    message: 'Central Laboratory information system maintenance is scheduled from 06:00 PM to 07:00 PM today.',
    category: 'broadcast',
    priority: 'low',
    timestamp: '08:45 AM',
    timeAgo: '2 hours ago',
    isRead: true,
    sender: 'Hospital IT Admin',
  },
  {
    id: 'notif-6',
    title: 'Time Slot Capacity Threshold',
    message: '10:00 AM - 11:00 AM Cardiology slot has reached maximum seat capacity.',
    category: 'system',
    priority: 'medium',
    timestamp: '08:15 AM',
    timeAgo: '3 hours ago',
