...
- Name: patient\signup.spec.ts >> Patient Registration Screen >> should complete 2-step registration and navigate to home
- Location: tests\patient\signup.spec.ts:53:3

# Error details

```
Error: locator.fill: Error: strict mode violation: getByPlaceholder('Enter phone number') resolved to 2 elements:
